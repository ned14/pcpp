...
# 122 "test/test-c/n_std.c"
    ...
    ((strcmp( "abcde", "abcde") == 0) ? (void) (0) : __assert_fail ("strcmp( \"abcde\", \"abcde\") == 0",
 "test/test-c/n_std.c"
# 125 "test/test-c/n_std.c" 3 4
    ,
 126
# 125 "test/test-c/n_std.c" 3 4
    , __PRETTY_FUNCTION__))
    ...
    ((abcde == 5) ? (void) (0) : __assert_fail ("abcde == 5",
 "test/test-c/n_std.c"
# 129 "test/test-c/n_std.c" 3 4
    ,
 130
# 129 "test/test-c/n_std.c" 3 4
    , __PRETTY_FUNCTION__))
...

{
    ...
    ((strcmp( "ab + cd", "ab + cd") == 0) ? (void) (0) : __assert_fail ("strcmp( \"ab + cd\", \"ab + cd\") == 0",
 "n_std.c"
# 616 "n_std.c" 3 4
    ,
 617
# 616 "n_std.c" 3 4
    ...
    ((strcmp( "\"abc\"", "\"abc\"") == 0) ? (void) (0) : __assert_fail ("strcmp( \"\\\"abc\\\"\", \"\\\"abc\\\"\") == 0",
 "n_std.c"
# 625 "n_std.c" 3 4
    ,
 626
...

{
    ...
    ((strlen( "16:10:15") == 8) ? (void) (0) : __assert_fail ("strlen( \"16:10:15\") == 8", "n_std.c", 786, __PRETTY_FUNCTION__));


    ((1) ? (void) (0) : __assert_fail ("1", "n_std.c", 789, __PRETTY_FUNCTION__));


    ((__STDC_VERSION__ >= 199409L) ? (void) (0) : __assert_fail ("__STDC_VERSION__ >= 199409L", "n_std.c", 792, __PRETTY_FUNCTION__));
...

{
    ...
    ((a + b + c == 6) ? (void) (0) : __assert_fail ("a + b + c == 6",
# 835 "n_std.c"
 "n_std.c"
# 826 "n_std.c" 3 4
    ,
...

{
    ...
    ((ABCDEFGHIJKLMNOPQRSTUVWXYZabcde == 31) ? (void) (0) : __assert_fail ("ABCDEFGHIJKLMNOPQRSTUVWXYZabcde == 31",
...
""
    ...
    int D1234567890123456789012 = 123459;
        ((a123456789012345678901234567890 == 123450 && D1234567890123456789012 == 123459) ? (void) (0) : __assert_fail ("a123456789012345678901234567890 == 123450 && D1234567890123456789012 == 123459",
 "n_std.c"
# 945 "n_std.c" 3 4
        ,
 946
